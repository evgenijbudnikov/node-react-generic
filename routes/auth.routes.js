...
router.post('/register',
    [
        check('email', 'Please enter valid email 11111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111').isEmail(),
